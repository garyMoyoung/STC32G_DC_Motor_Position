...
void PWMB_Encoder_Init(void)
{
    ...
    // ===== 关键：输入捕获模式配置 =====
    // CCMR1: IC1F[7:4] = 1111(最大滤波 f/32×N=8 ≈7.7us), CC1S[1:0] = 01(TI1输入)
    // = 1111_0001 = 0xF1
    // 注：滤波从0x31(0.24us)提升到0xF1(7.7us)，用于抑制10kHz PWM开关噪声干扰
    PWMB_CCMR1  = 0xF1;        // TI1输入，最大滤波（7.7us），抑制PWM噪声

    // CCMR2: IC2F[7:4] = 1111, CC2S[1:0] = 01(TI2输入)
    // = 1111_0001 = 0xF1
    PWMB_CCMR2  = 0xF1;        // TI2输入，最大滤波（7.7us），抑制PWM噪声
